                ...
                if (graphServiceClient != null)
                {
                    ...
                    while (sendMail)
                    {
                        ...
                        Console.WriteLine("Hello, " + displayName +
                                          ". Would you like to send an email to yourself or someone else?");
                        Console.WriteLine(
                        ...
                        await MailHelper.ComposeAndSendMailAsync(
                            "Welcome to Microsoft Graph development with C# and the Microsoft Graph Connect sample",
                            Constants.EmailContent, messageAddress);
